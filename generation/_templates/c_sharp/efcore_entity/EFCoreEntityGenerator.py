...
def column_is_inherited(column, entity):
    if column.column_name in entity.inherited_properties:
        return True
    else:
        return False
...
class EFCoreEntityGenerator(BaseGenerator.BaseGenerator):
    ...
    def return_template(self, loaded_template, lookup_template):
        ...
        j2_enviroment.filters["column_is_inherited"]=column_is_inherited
