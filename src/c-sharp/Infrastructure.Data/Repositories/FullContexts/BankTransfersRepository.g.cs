...
using CodeGenerator.Infrastructure.Data.Context.SqlServer;
...
{
	public class BankTransfersRepository : Repository<BankTransfers, FullContext>, IBankTransfersRepository
	{
	#region Constructors

	public BankTransfersRepository(FullContext context)
		: base(context)
	{
	}
